...
- Full functional real world ELT data pipeline to data science app orchestration with full observability (whole pipeline including DAGs inside dbt)
...
This is a . The main purpose of this project is to showcasing the knowledge and skills involved in producing a tailor-made and well-managed workflow using state of the art healthcare data solutions.
